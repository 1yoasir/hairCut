...
Vue.component("crear-trabajador", require("./admin/components/CrearTrabajador.vue").default);
Vue.component("crear-servicio", require("./admin/components/CrearServicio.vue").default);
Vue.component("horario", require("./usuarios/components/trabajador/Horario.vue").default);
